...
#inventory seeds
Inventory.create(user_id: 1)
Inventory.create(user_id: 2)
Inventory.create(user_id: 3)Inventory.create(user_id: 4)
Inventory.create(user_id: 5)
Inventory.create(user_id: 6)
